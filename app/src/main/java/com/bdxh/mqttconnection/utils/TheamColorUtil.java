...
public class TheamColorUtil {
    ...
    private SharedPreferences setting = PreferenceManager.getDefaultSharedPreferences(App.context);

    public static TheamColorUtil getInstance() {
        return TheamColorUtilInstance.instance;
    }
    ...
    public boolean getIsNoPhotoMode() {
        return setting.getBoolean("switch_noPhotoMode", false) && NetworkUtils.isMobileData();
    }
     ...
     */
    public int getColor() {
        int defaultColor = App.context.getResources().getColor(R.color.colorPrimary);
    ...
    public boolean getIsVideoAutoPlay() {
        return setting.getBoolean("video_auto_play", false) && NetworkUtils.isWifiConnected();
    }
    ...
    private static final class TheamColorUtilInstance {
        private static final TheamColorUtil instance = new TheamColorUtil();
    }
}
